...
jinja = {
	"methods": [
		"cecypo_powerpack.jinja.get_document_public_link",
...
after_install = [
    "cecypo_powerpack.price_approval.setup_custom_fields",
    "cecypo_powerpack.copy_as_message.seed_client_scripts",
]
after_migrate = [
    "cecypo_powerpack.price_approval.after_migrate",
    "cecypo_powerpack.copy_as_message.seed_client_scripts",
]
